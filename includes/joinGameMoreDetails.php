...
?>
  ...
  <main id="main">
          ...
          <div class="row">
            <div class="col-md-6">
             <div class="container">
              ...
              <h3 class="title">פרטי המשחק</h3>
              <h5><?php echo "חוף: ".$_POST['beachName'] ?></h5>
              <h5><?php echo "כתובת: ". $_POST['address'] ?></h5>
              <h5><?php echo "תאריך: ". $_POST['gameDate'] ?></h5>
              <h5><?php echo "שעה: ". $_POST['gameTime'] ?></h5>
              <h5><?php echo "סוג קרקע: ". $_POST['groundType'] ?></h5>
              <h5><?php echo "מספר שחקנים: ". $_POST['currentNumberOfPlayers']. "/" . $_POST['numberOfPlayers'] ?></h5></br>
              <h3 class="title">פרטי הקפטן</h3>
              <h5><?php echo "שם הקפטן: ". $_POST['captainName'] ?></h5>
              <h5><?php echo "מספר טלפון: ". '0'. $_POST['captainPhone'] ?></h5><br>
              <form class="" action="javascript:joinGame()" method="post">
                ...
                <input type="button" class="btn btn-primary" onclick="location.href='joinGame.php';" value="חזרה למשחקים פעילים" />
              </form>
              </div>
             </div>
            </div>
    ...
    function joinGame() {
      ...
      alertify.confirm('', 'כדי להצטרף למשחק יש ללחוץ אישור',
        function() {
